#
# Combined Data Cleaning Script
#
# This script performs two cleaning operations on test files:
# 1. Removes any rows with 'Text' that also exists in the training file.
# 2. Removes any rows where the 'Text' has fewer words than a set minimum.
#
...
TEST_FILES_TO_CLEAN = {
    'testing_10_percent_processed_corpus_part_1.csv': 'testing_10_percent_processed_corpus_part_1_clean.csv',
