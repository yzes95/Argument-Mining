...
def extract_ngram_features(processed_data):
    ...
    """
    # TODO:
    # Initialize TfidfVectorizer. A good starting point is `ngram_range=(1, 2)` and `max_features=3000` to keep the size manageable.
    # .fit_transform() method used to create the feature matrix.
