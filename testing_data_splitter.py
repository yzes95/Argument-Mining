#
# Script to split a processed data file into validation and test sets.
#
# This script assumes you have already created a CSV file containing the 20% of
# your data that is intended for validation and testing.
# It will split that file 50/50 to produce two new files:
# - validation_corpus.csv (10% of the original total)
# - test_corpus.csv (10% of the original total)
#
...
def split_data(filepath):
    ...
    try:
        ...
        print("Please make sure the file exists and the INPUT_20_PERCENT_FILE variable is set correctly.")
        return
    ...
    print(f"\nSplitting data...")
    print(f"  - Tests_part_1 set size: {len(y_val)}")
    print(f"  - Tests_part_2 set size:       {len(y_test)}")
