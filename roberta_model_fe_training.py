#
# Implemented Script for Fine-Tuning a RoBERTa Model (Phase 3)
#
# This script provides a complete, workable implementation for fine-tuning
# a pre-trained RoBERTa model for text classification, with TODO comments
...
def load_and_prepare_datasets(train_path, val_path, test_path):
    ...
    """
    # TODO: Use pandas to load your three CSV files into DataFrames.
...
# --- Step 2: Tokenization ---
# TODO: Initialize the tokenizer for your chosen RoBERTa model.
...
def main():
 # --- Load and Tokenize Data ---
    # TODO: Call your `load_and_prepare_datasets` function.
    raw_datasets = load_and_prepare_datasets(TRAIN_CSV_PATH, VALIDATION_CSV_PATH, TEST_CSV_PATH_UKP)
    
    # TODO: Use the `.map()` method to apply the `tokenize_function` to all data splits.
    tokenized_datasets = raw_datasets.map(tokenize_function, batched=True)

    # --- Initialize the Model ---
    # TODO: Load the `RobertaForSequenceClassification` model, specifying `num_labels=2`.
    ...
    # TODO: Call `trainer.train()` to start the training.
    trainer.train()

    # --- Final Evaluation on the Test Set ---
    print("\n--- Evaluating on the Test Set ---")
    # TODO: Call `trainer.evaluate()` on the test set and print the results.
    ...
    # TODO: Call `trainer.save_model()` to save the best model.
