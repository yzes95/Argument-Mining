...
#
# This script is a template designed to guide you through the process of reading
# the raw AAEC dataset and transforming it into a clean, labeled format
# suitable for machine learning tasks.
#
# Each function has a comment block explaining its purpose, what parameters it
# expects, and what it should return. Your task is to fill in the code for
# each function based on these guidelines.
"""
...
# --- Configuration ---
# This is where you will set the path to your dataset folder.
...
def load_essay_text(txt_filepath):
    ...
    # Hint: Use `with open(...) as f:` and `f.read()`. Remember to handle encoding.
    # print(txt_filepath)
    try:
...
def parse_annotation_file(ann_filepath):
    ...
    """
    # TODO:
    # 1. Check if the annotation file exists.
...
def identify_non_argumentative_segments(full_essay_text, argumentative_components):
    ...
    - RETURNS: A list of dictionaries. Each dictionary represents one non-argumentative
               sentence and should contain its text and the label 'Non-Argumentative'.
               Example: [{'text': 'This is a background sentence.', 'label': 'Non-Argumentative'}, ...]
    """
    last_end_pos = 0
    ...
    file_headers = ["Type","StartPos","EndPos","Text"]
    # TODO:
    # This is the most complex function. Here is a plan:
    ...
    #    and append it to the `non_argumentative_segments` list.
...
def process_essay_directory(essay_id):
    ...
    # TODO:
    # 1. Loop through each file in the directory using `os.listdir()`.
    # 2. If a file ends with ".txt":
...
# This is the part of the script that runs when you execute it from the command line.
def main():
    # TODO:
...
if __name__ == "__main__":
    ...
    main()
    # print(
    #     "\nData processing script guide complete. Fill in the TODO sections to implement the logic."
    # )
